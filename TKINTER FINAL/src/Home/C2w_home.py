...
class homeLabel(tk.Frame):
    def __init__(self, parent, main_frame, userData):
        ...
        img_path = os.path.join(script_directory,"../../assets/c2w.png")
        ...
        self.c2w_right_label = tk.Label(self.c2w_right_frame,
        text=self.c2w_original_label_text, background="#BCD2E8", font=("Poppins", 50,"bold"), fg=tk_color)
