...
class MainFrame():
    def __init__(self, parent, main_frame, userData):
        ...
        self.root.iconbitmap("./assets/core2web.png")
        self.logIn()
    def logIn(self):
...
# ============ Left Side Image================================================
#========================================================================
        self.side_image = Image.open('./assets/core2web.png')
...
# ============ Sign In Image=============================================
#========================================================================
        self.sign_in_image = Image.open('./assets/hyy.png')
...
# ============================login button================================
        self.lgn_button = Image.open('./assets/btn1.png')
...
# ========= show/hide password==================================================================
        self.show_image = ImageTk.PhotoImage \
            (file='./assets/show.png')
        self.hide_image = ImageTk.PhotoImage \
            (file='./assets/hide.png')
